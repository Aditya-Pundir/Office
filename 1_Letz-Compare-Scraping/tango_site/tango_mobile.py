...
def get_paths():
    ...
    if os.path.exists('C:\\Users\\adity\\Documents\\Code-Playground\\Freelance\\1_Letz-Compare-Scraping\\tango_site\\config.ini'):
        with open('C:\\Users\\adity\\Documents\\Code-Playground\\Freelance\\1_Letz-Compare-Scraping\\tango_site\\config.ini', 'r') as f:
            paths = f.readlines()
